...
self.addEventListener('message', function (e) {
    ...
    //will include all our functions, so we can call everything at once
    var bigFunction = ``
    ...
    bigFunction += `return ${functionToUse}(${uniqueFunctionParams ? "game.moves(), game" : ""})`

    var makeRandomMove = new Function('game', 'side', 'positionMap', 'pieceVal', bigFunction)

    postMessage(makeRandomMove(game, game.turn(), positionMap, pieceVal));
});